/* mwb_wn_nofollow_checkbox v1.1.5 | GPLv2 License | by fabiosantos.me */
/* global ajaxurl, tinymce, mwb_link, setUserSetting, wpActiveEditor */

var wpLink;

( function( $, mwb_link, wp ) {
    ...
    wpLink = {
        ...
        init: function() {
            // Add custom checkbox
            var mwb_wn_Checkbox = '<div><label><span> </span><input type="checkbox" id="mwb_wn_nofollow_checkbox" />rel="nofollow"</label></div>';
            $(mwb_wn_Checkbox).insertAfter( '#wp-link .link-target' );
            ...
            inputs.noFollow = $( '#mwb_wn_nofollow_checkbox' );
        ...
        mceRefresh: function( searchStr, text ) {
            ...
            if ( linkNode ) {
                ...
                if ( href !== '_wp_link_placeholder' ) {
                    ...
                    inputs.submit.val( mwb_link.update );
                } else {
        ...
        htmlUpdate: function() {
            ...
            wp.a11y.speak( mwb_link.linkInserted );
        },
        ...
        setDefaultValues: function( selection ) {
            ...
            // Update save prompt.
            inputs.submit.val( mwb_link.save );
        },
            ...
            if ( ! results ) {
                if ( firstPage ) {
                    list += '<li class="unselectable no-matches-found"><span class="item-title"><em>' +
                        mwb_link.noMatchesFound + '</em></span></li>';
                }
            } else {
                $.each( results, function() {
                    ...
                    list += this.title ? this.title : mwb_link.noTitle;
...
})( jQuery, window.mwb_link, window.wp );
